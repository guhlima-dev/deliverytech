...
public class PedidoService {
    ...
    public PedidoService(PedidoRepository pedidoRepository, ClienteRepository clienteRepository,
                         ...
                         ModelMapper mapper, ProdutoRepository produtoRepository) {
    ...
    public PedidoResponseDTO atualizarStatus(Long pedidoId){
        ...
        switch(statusAtual){
            ...
            case PREPARANDO -> pedido.setStatus(StatusPedido.A_CAMINHO);
            case A_CAMINHO -> pedido.setStatus(StatusPedido.ENTREGUE);

            case CANCELANDO, ENTREGUE ->
